...
class TestAdjoint:
    @pytest.mark.parametrize('mkey, shape, kernel, space_order, time_order, setup_func', [
        ...
        # # Constant model in 2D and 3D
        # ('constant', (60, 70), 'OT2', 10, 2, vector_reflectivity_setup),
        # ('constant', (60, 70, 80), 'OT2', 8, 2, vector_reflectivity_setup),
        # ('constant', (60, 70), 'OT2', 4, 2, vector_reflectivity_setup),
        # ('constant', (60, 70, 80), 'OT4', 2, 2, vector_reflectivity_setup),
    ])
